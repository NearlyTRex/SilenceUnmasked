...
//addMaterialMapping("Wall_filler101m" , "detail: my.game/data/interiors/lightingPack/wall_detail"); 
...
//   sizeX       = 2;
//   sizeY       = 2;
//   textureName = "my.game/data/shapes/lightingPack/Arrow";
...
//   category = "Pipe";
//   className = "PipeClass";
//   shapeFile = "my.game/data/shapes/lightingPack/pipe.dts";
//};
...
//   category = "Lights";
//   className = "SpotSwing";
//   shapeFile = "my.game/data/shapes/lightingPack/spotswing.dts";
//};
...
//   category = "Trees";
//   className = "Tree2";
//   shapeFile = "my.game/data/shapes/trees/tree2.dts";
//};
//
...
{
  animateTexture = "0";
  animTexName[0] = "my.game/data/particles/smoke";
