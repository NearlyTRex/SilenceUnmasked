...
{
filename = "my.game/data/sound/crossbow_reload.ogg";
...
{
filename = "my.game/data/sound/relbow_mono_01.ogg";
description = AudioClose3d;
preload = true;
};
...
{
filename = "my.game/data/sound/crossbow_firing_empty.ogg";
description = AudioClose3d;
preload = true;
};
...
{
filename = "my.game/data/sound/explosion_mono_01.ogg";
...
datablock ParticleData(CrossbowSplashMist)
{
   ...
   spinRandomMin        = -90.0;
   spinRandomMax        = 500.0;
   textureName          = "my.game/data/shapes/crossbow/splash";
...
datablock SplashData(CrossbowSplash)
{
   ...
   texture = "my.game/data/shapes/crossbow/splash";
...
{
   textureName          = "my.game/data/particles/smoke";
   dragCoefficient     = 0.0;
...
{
   textureName          = "my.game/data/particles/bubble";
   dragCoefficient      = 0.0;
...
{
   textureName          = "my.game/data/particles/fire";
   dragCoefficient      = 0;
...
{
   shapeFile = "my.game/data/shapes/crossbow/debris.dts";
...
{
   textureName          = "my.game/data/particles/spark";
   dragCoefficient      = 1;
   gravityCoefficient   = 0.0;
   inheritedVelFactor   = 0.2;
   constantAcceleration = 0.0;
...
{
   projectileShapeName = "my.game/data/shapes/crossbow/projectile.dts";
   directDamage        = 20;
   radiusDamage        = 20;
   damageRadius        = 1.5;
   areaImpulse         = 2000;
...
datablock ItemData(CrossbowAmmo)
{
   ...
   shapeFile = "my.game/data/shapes/crossbow/ammo.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
...
datablock ItemData(Crossbow)
{
   ...
   // Basic Item properties
   shapeFile = "my.game/data/shapes/crossbow/weapon.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
