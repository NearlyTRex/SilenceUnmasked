...
datablock AudioProfile(Snowstormsound)
{
   filename    = "~/data/sound/waste.ogg";
   description = AudioLooping2d;
   volume   = 1.0;
...
datablock PrecipitationData(Snowstorm)
{
   soundProfile = "Snowstormsound";

   dropTexture = "~/data/environment/SnowstormDrop";
   splashTexture = "~/data/environment/SnowstormSplash";
   dropSize = 10;
   splashSize = 2;
   useTrueBillboards = false;
   splashMS = 250;
...
{
   dropTexture = "~/data/environment/SnowDrop";
   splashTexture = "~/data/environment/SnowSplash";
   dropSize = 0.27;
   splashSize = 0.27;
   useTrueBillboards = false;
   splashMS = 50;
