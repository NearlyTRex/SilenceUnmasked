...
{
   textureName          = "my.game/data/particles/darksmoke";
   dragCoefficient     = 0.0;
...
{
   textureName          = "my.game/data/particles/firefly";
   dragCoefficient      = 0.0;
   windCoefficient      = 5.0;
...
{
   textureName          = "my.game/data/particles/ember";
   dragCoefficient      = 0.0;
   windCoefficient      = 0.0;
